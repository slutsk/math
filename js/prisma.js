...
function quadrilateral(cxt, x1, y1, x2, y2, x3, y3, x4, y4, width ,fillColor, strokeColor, fill){
...
drawLine(ctx01, x + left, y + h, x + a + left, y + h, "lightblue", 3, 10);
drawLine(ctx01, x + left, y + h, x, y, "lightblue", 3, 10);
drawLine(ctx01, x + left + 40, y + h - 80, x, y, "lightblue", 3, 0);
drawLine(ctx01, x + left + k, y + h - 80, x - k, y, "lightblue", 3, 0);
drawLine(ctx01, x + a + left, y + h, x + a, y, "lightblue", 3, 10);
                   //drawLine(ctx01, x + a + left, y + h, x + a, y, "lightblue", 3, 0);
ctx01.fill();

drawLine(ctx01, x + a + k, y, x + a2 + k, y + b, "lightblue", 3, 0);
drawLine(ctx01, x + a2, y + b, x - a2, y + b, "lightblue", 3, 0);
drawLine(ctx01, x - k, y , x - a2 - k, y + b, "lightblue", 3, 0);

drawLine(ctx01, x + a + left + k, y + h, x + a2 + left + k, y + b + h, "lightblue", 3, 0);
drawLine(ctx01, x + a2 + left, y + b + h, x - a2 + left, y + b + h, "lightblue", 3, 0);
drawLine(ctx01, x + left - k, y + h, x - a2 + left - k, y + b + h, "lightblue", 3, 10);
drawLine(ctx01, x + left - k, y + h, x - a2 + left - k, y + b + h, "lightblue", 3, 10);
drawLine(ctx01, x + left - k - 70, y + h + 70, x - a2 + left - k, y + b + h, "lightblue", 3, 0);


drawLine(ctx01, x + left - k, y + h, x - k, y, "lightblue", 3, 10);

drawLine(ctx01, x + a + left+k, y + h, x + a+k, y, "lightblue", 3, 0);
drawLine(ctx01, x + a2 + left, y + b + h, x + a2, y + b, "lightblue", 3, 0);
drawLine(ctx01, x + a2 + left + k, y + b + h, x + a2 + k, y + b, "lightblue", 3, 0);
drawLine(ctx01, x - a2 + left, y + h + b, x - a2, y + b, "lightblue", 3, 0);
